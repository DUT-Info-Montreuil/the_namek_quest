...
public class BFS {
    ...
    public BFS(Environnement env) {
        ...
        this.g = new Grille(this.env,(env.getTrunks().getY()+5*Constante.TAILLE_TUILE)/Constante.TAILLE_TUILE,(env.getTrunks().getX()+5*Constante.TAILLE_TUILE)/Constante.TAILLE_TUILE,(env.getTrunks().getX()-5*Constante.TAILLE_TUILE)/Constante.TAILLE_TUILE,(env.getTrunks().getY()-5*Constante.TAILLE_TUILE)/Constante.TAILLE_TUILE);
        algoBFS();
    }
